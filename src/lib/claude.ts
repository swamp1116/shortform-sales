...
2줄: 반드시 "AI 검색 최적화"라는 단어를 포함하여 업종별 훅을 자연스럽게 녹인 한 문장 (예: "요즘 네이버 블로그보다 AI 검색 최적화가 중요해지고 있어서요"). 팔로워수/릴스 유무도 언급
3줄: 논의 후 가볍게 샘플 영상 제작도 가능하다는 톤의 제안
4줄: 반드시 "짧게 통화나 미팅 가능하실까요?" 로 마무리
